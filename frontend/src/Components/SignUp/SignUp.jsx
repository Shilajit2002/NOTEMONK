          ...
          <form onSubmit={handleSignUp}>
            ...
            <Box className="signUpbox">
              ...
              <TextField
                ...
                name="firstname"
                value={
                  user.firstname ? user.firstname.trim("") : user.firstname
                }
            ...
            <Box className="signUpbox">
              ...
              <TextField
                ...
                type="text"
                name="lastname"
                value={user.lastname ? user.lastname.trim("") : user.lastname}
                onChange={handleUserChange}
                className="signUpInput"
                variant="filled"
                InputProps={{
            ...
            <Box className="signUpbox">
              ...
              <FormControl className="signUpInput">
                ...
                >
                  {/* Menu Item */}
                  <MenuItem disabled selected value="Choose Your Country">
                    Choose Your Country
                  </MenuItem>
                  {countries?.map((option, index) => {
                    return (
                      <MenuItem
                        key={index}
                        value={option.label + "(+" + option.phone + ")"}
                        sx={{
            ...
            <Box className="signUpbox">
              ...
              <TextField
                ...
                onBlur={() => {
                  if (!/^([+]?[0-9]{1,4}[ -]?)?([0-9]{10})$/.test(user.phone)) {
                    setAlert({
                      ...alert,
