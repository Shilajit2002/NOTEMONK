                ...
                <div className="signinRight">
                    ...
                    <form onSubmit={handleSignIn}>
                        ...
                        <Box className="signinbox">
                            ...
                            {/* Text Field */}
                            <TextField label="User Name" color='warning' type='text' name='username' value={user.username ? user.username.trim("") : user.username} onChange={handleUserChange} className='signinInput' variant='filled' InputProps={{
                                style: {
                                    color: "white",
                                    fontWeight: "500",
                                    letterSpacing: "0.5px"
                        ...
                        <Box className="signinbox">
                            ...
                            {/* Text Field */}
                            <TextField label="Email Id" color='warning' type='text' name='email' value={user.email ? user.email.trim("") : user.email} onChange={handleUserChange} className='signinInput' variant='filled' InputProps={{
                                style: {
                                    color: "white",
                                    fontWeight: "500",
                                    letterSpacing: "0.5px"
                        ...
                        <Box className="signinbox">
                            ...
                            {/* Text Field */}
                            <TextField label="Password" color='warning' type={hidePass.type} name='password' value={user.password ? user.password.trim("") : user.password} onChange={handleUserChange} className='signinInput' InputProps={{
                                style: {
                                    color: "white",
                                    fontWeight: "500",
                                    letterSpacing: "0.5px"
                        ...
                        <button type="submit" className="signupin">Sign In</button>

                        <p style={{ textAlign: 'center', margin: '5px 0',color:'white' }}>OR</p>
                        <p style={{ textAlign: 'center', margin: '5px 0',color:'white' }}>Not have an account?</p>
