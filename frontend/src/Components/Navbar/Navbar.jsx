                                            ...
                                            username ? <>
                                                ...
                                                <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                                                    ...
                                                    <Tooltip title="Profile" sx={{ zIndex: 9999 }}>
                                                        ...
                                                        >
                                                            ...
                                                            <Avatar sx={{ ml: 2, width: 32, height: 32, bgcolor: stringToColor(username.firstname.toUpperCase()) }}>{username.firstname.charAt(0).toUpperCase()}</Avatar>
                                                        </IconButton>
                                                    </Tooltip>
                                                </Box>
                                                {/* Menu bar */}
                                                ...
                                                >
                                                    ...
                                                    <MenuItem onClick={() => {
                                                        ...
                                                        color: 'white', fontWeight: 500, letterSpacing: '1px',
                                                    ...
                                                    <MenuItem onClick={() => {
                                                        ...
                                                        color: 'white', fontWeight: 500, letterSpacing: '1px', '&:hover': {
                                                            backgroundColor: '#0f000ac4 !important', // Change the background color on hover
                                                        }
                                                    }}>
                                                        <ListItemIcon>
                                                            <AccountCircleIcon style={{ color: 'white' }} fontSize="small" />
                                                        </ListItemIcon>
                                                        Profile
                                                    </MenuItem>
                                                    ...
                                                    <MenuItem onClick={() => {
                                                        ...
                                                        <ListItemIcon>
                                                            <SpaceDashboardIcon style={{ color: 'white' }} fontSize="small" />
                                                        </ListItemIcon>
                                                        Dashboard
                                                    </MenuItem>
                                                    ...
                                                    <MenuItem onClick={() => {
                                                        ...
                                                        <ListItemIcon>
                                                            <NotesIcon style={{ color: 'white' }} fontSize="small" />
                                                        </ListItemIcon>
                                                        Your Notes
                                                    </MenuItem>
                                                    ...
                                                    <MenuItem onClick={() => {
                                                        ...
                                                        <ListItemIcon>
                                                            <NoteAddIcon style={{ color: 'white' }} fontSize="small" />
                                                        </ListItemIcon>
                                                        Add Notes
                                                    </MenuItem>
                                                ...
                                                <>
                                                    ...
                                                    <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                                                        {/* Name Skeleton */}
                                                        <Skeleton variant="text" sx={{ fontSize: '1rem', mr: 1, backgroundColor: '#cdecff77', width: '100px', height: '32px' }} />

                                                        {/* Logo Skeleton */}
                                                        <Skeleton variant="circular" sx={{ backgroundColor: '#cdecff77' }} width={32} height={32} />
                                                    </Box>
                                                </>
                                        }
